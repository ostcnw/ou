...
Remember: <b>Google is your friend</b>. When you are developing software or apps in the future, you will most certainly have to use tools you have not heard of before. Googling documenation for these tools is almost a neccessity, and there is no shame in doing so. Even if you are using a toolset you are familar with, google may provide the best and most efficent/time saving solutions to your problem/task. View the github documentation here to learn more about branches. https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/about-branches
